    ...
    <main>
      ...
      <section class="section">
        <form class="form-datos-tipo-tramite">
          <div>
            <label>Nombre</label>
            <input class="input" type="text" placeholder="Nombre de Trámite" value="Convalidación"/>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describa la documentación mínima necesaria para crear el trámite.
