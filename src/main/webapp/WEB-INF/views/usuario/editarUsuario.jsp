    ...
    <main>
      ...
      <section class="section">
        <form class="form-datos-usuario">
          <div>
            <label>Nombre</label>
            <input class="input" type="text" placeholder="Nombre de Usuario" value="Luis Pérez" />
          </div>

          <div>
            <label>Documentación de Identidad</label>
            <input class="input" type="text" placeholder="12345678" value="45613248"/>
          </div>
          ...
          <div>
            ...
            <select class="select">
              ...
              <option value="area-academica" selected>Área Académica</option>
