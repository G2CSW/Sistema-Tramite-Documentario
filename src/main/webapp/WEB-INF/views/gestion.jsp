    ...
    <%@ include file="barraLateral.jsp" %>
      ...
      <main>
        ...
        <section class="seccion-gestion">
          <c:if
            test="${sessionScope.usuario.area == 'Mesa de Partes' || sessionScope.usuario.area == 'Área de Evaluación'}">
          ...
          <div class="targetas-gestion">
            ...
            <c:if test="${sessionScope.usuario.area == 'Mesa de Partes'}">
              <a href="/archivados/listar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <c:if test="${sessionScope.usuario.area == 'Admin' || sessionScope.usuario.area == 'Administrador'}">
          <section class="seccion-gestion">
            <h2>Configuración</h2>
            <div class="targetas-gestion">
              <a href="/tipoTramite/listar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                </svg>Tipos de Trámites</a>
              <a href="/documento/listar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              ...
              <a href="/usuario/listar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          ...
          <section class="seccion-gestion">
            <h2>Estadísticas</h2>
            <div class="targetas-gestion">
              <a href="/metricas"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
