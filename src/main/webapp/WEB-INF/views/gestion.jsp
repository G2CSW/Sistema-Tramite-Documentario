                ...
                <main>
                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.usuario}">
                            ...
                            <section class="seccion-gestion">
                                <c:if test="${sessionScope.usuario.area == 'Mesa de Partes'}">
                                    <div class="targetas-gestion">
                                        <a href="/solicitante/listar">Solicitante</a>
                                    </div>
                                </c:if>
                                <c:if
                            ...
                            <c:if
                                test="${sessionScope.usuario.area == 'Admin' || sessionScope.usuario.area == 'Administrador'}">
                                <section class="seccion-gestion">
                                    <h2>Configuración</h2>
                                    <div class="targetas-gestion">
                        ...
                        <c:otherwise>
                            <section class="seccion-gestion mensaje-sesion">
                                ...
                                <p>
                                    Inicia sesión para ver las funcionalidades de gestión disponibles según tu perfil de
                                    usuario.
                                </p>
                            </section>
                        </c:otherwise>
